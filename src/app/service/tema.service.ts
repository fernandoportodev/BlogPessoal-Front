...
export class TemaService {
  ...
  getByIdTema(id: number): Observable<Tema> {
    return this.http.get<Tema>(`blogpessoalthiago.herokuapp.com/temas/${id}`, this.token)
  }
  ...
  deleteTema(id: number){
    return this.http.delete(`blogpessoalthiago.herokuapp.com/temas/${id}`, this.token)
  }
}
